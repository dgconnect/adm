...
rm *.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/criarusuario.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/remover.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/AlterarSenha.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/AlterarData.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/KillUser.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/sshmonitor.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/dgconnect/adm/master/alterarlimite.sh > /dev/null 2>&1
chmod 777 *sh
